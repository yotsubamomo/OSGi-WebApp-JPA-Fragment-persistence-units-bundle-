 ...
 */
class MySpringPersistenceUnitInfo extends MutablePersistenceUnitInfo {
	...
	public void addTransformer(ClassTransformer classTransformer) {
		...
		this.loadTimeWeaver.addTransformer(new MyClassFileTransformerAdapter(classTransformer));
	}
