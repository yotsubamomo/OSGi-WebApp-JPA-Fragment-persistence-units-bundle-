 ...
 */
class MyClassFileTransformerAdapter implements ClassFileTransformer {
	
	private static final Log logger = LogFactory.getLog(MyClassFileTransformerAdapter.class);

	private final ClassTransformer classTransformer;


	public MyClassFileTransformerAdapter(ClassTransformer classTransformer) {
